...
import net.minecraftforge.fml.common.ObfuscationReflectionHelper;  // <-- ПРАВИЛЬНЫЙ ИМПОРТ!
...
public class ModSpawnEggItem extends SpawnEggItem {
    ...
    public static void initSpawnEggs() {
        ...
        IDispenseItemBehavior dispenseItemBehavior = new DefaultDispenseItemBehavior() {
