...
public class LightningChannelerScreen extends ContainerScreen<LightningChannelerContainer> {
    ...
    public LightningChannelerScreen(LightningChannelerContainer container,
    ...
    protected void renderBg(MatrixStack matrixStack, float partialTicks, int mouseX, int mouseY) { // ✅ Исправлено имя
        ...
        // Рисуем молнию (если гроза)
        if (this.menu.isLightningStorm()) { // ✅ container -> menu
            this.blit(matrixStack, x + 82, y + 9, 176, 0, 13, 17);
        }
    }
