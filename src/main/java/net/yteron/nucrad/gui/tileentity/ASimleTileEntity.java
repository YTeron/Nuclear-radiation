...
public class ASimleTileEntity extends TileEntity implements IRecipeHolder, ITickableTileEntity, IRecipeHelperPopulator
{
    ...
    protected final IIntArray dataAccess = new IIntArray() {
        public int get(int p_221476_1_) {
            switch(p_221476_1_) {
                case 0:
                    return ASimleTileEntity.this.cookingProgress;
                case 1:
                    return ASimleTileEntity.this.cookingTotalTime;
                default:
                    return 0;
            }
        }
        ...
        public void set(int p_221477_1_, int p_221477_2_) {
            switch(p_221477_1_) {
                case 0:
                    ASimleTileEntity.this.cookingProgress = p_221477_2_;
                    break;
                case 1:
                    ASimleTileEntity.this.cookingTotalTime = p_221477_2_;
            }
    ...
    public ASimleTileEntity(TileEntityType<?> tileEntityType, IRecipeType<ConcereteMixerRecipe> recipeType) {
        super(tileEntityType);
        this.recipeType = recipeType;
    }
    public ASimleTileEntity() {
